...
const s = {
  ...
  input:      { fontSize: 13, color: '#111', padding: '6px 8px', border: '0.5px solid #185FA5', borderRadius: 6, outline: 'none', width: '100%', boxSizing: 'border-box', background: '#F0F7FF' },
  btnEditar:  { fontSize: 12, padding: '7px 14px', borderRadius: 8, border: '0.5px solid #ccc', background: '#fff', cursor: 'pointer', color: '#333' },
  btnGuardar: { fontSize: 12, padding: '7px 14px', borderRadius: 8, border: 'none', background: '#0C447C', cursor: 'pointer', color: '#fff', fontWeight: 500 },
